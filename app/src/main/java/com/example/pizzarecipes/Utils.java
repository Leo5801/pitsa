...
public class Utils {
    ...
    public static final String PIZZA_1_RECIPE = "STEP 1\n" +
            ...
            "Promoted stories by\n" +
            "Spanish potatoesSpanish potatoes\n" +
            "Spanish potatoes\n" +
            "BBC Good Food\n" +
            "Oven-baked rösti cakeOven-baked rösti cake\n" +
            ...
            "colinlizsmart\n" +
            "3 months ago\n" +
            "I used a different dough but topping wasn't as nice as I expected - it was as other comments said, a bit bland\n" +
            "\n" +
            "17a.bennett\n" +
            "3 months ago\n" +
            "dough was terrible came out like plasterboard\n" +
            "\n" +
            "wizzi_100\n" +
            "1 year ago\n" +
            "I made it with a supermarket pizza base. Taste was nice, but a bit too much onion compared to other ingredients.\n" +
            "\n" +
            "dave6376 avatar\n" +
            "dave6376\n" +
            "2 years ago\n" +
            "A star rating of 2 out of 5.\n" +
            "Bland, tasteless and not really worth the effort.\n" +
            "\n" +
            "mmjsampson02\n" +
            "11 months ago\n" +
            "Yeah Dave, great comeback\n" +
            "\n";
    ...
    public static final String PIZZA_3_TITLE = "Next level Margherita pizza";
    ...
    public static final String PIZZA_9_TITLE = "No yeast pizza dough";
    public static final String PIZZA_9_DESCRIPTION = "Try this easy no yeast recipe for pizza dough using just flour, baking powder, salt and oil. Recipe by Helen Hurrell, mum of BBC Good Food member Eleanor";
    ...
    public static final String PIZZA_10_TITLE = "Rainbow pizzas";
    public static final String PIZZA_10_DESCRIPTION = "Forget takeaway pizzas, encourage kids to eat a rainbow every day with this colourful recipe full of fresh flavours – guaranteed to please even fussy eaters";
