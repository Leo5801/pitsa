...
public class PizzaRescipeAdapter extends RecyclerView.Adapter<PizzaRescipeAdapter.PizzaRecipeViewHolder> {

    ArrayList<PizzaRecipeItem> pizzaRecipeItems;
    Context context;

    public PizzaRescipeAdapter(ArrayList<PizzaRecipeItem> pizzaRecipeItems, Context context) {
    ...
    @NonNull
    @Override
    public PizzaRescipeAdapter.PizzaRecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    class PizzaRecipeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            intent.putExtra("discription",pizzaRecipeItem.getDescription());
